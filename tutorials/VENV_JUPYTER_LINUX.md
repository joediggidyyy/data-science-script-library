# Linux: venv + Jupyter in VS Code

This guide is for Linux students using a shell terminal.

## Step 1: Open the project folder

Open your terminal and navigate to `projects/data-science-script-library`.
...
```text
python3 scripts/repo/setup/setup_student_env.py --deps tensorflow-class --python /usr/bin/python3.13
```
